...
public:
    ...
    static nlohmann::json loadNames(std::string assetsPath);
...
private:
    ...
    std::string state = ""; // Which animation should be rendered
    std::string lastFrameState = ""; // Which animation was rendered in the last frame
};
